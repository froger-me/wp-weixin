...
<html <?php language_attributes(); ?>>
	...
	<body class="wechat-auth">
		<div class="weui-desktop-head">
			<div class="weui-desktop-account"></div>
		</div>
		<div class="desktop-qr-inner">
			<h2><?php esc_html_e( 'Authenticate with WeChat', 'wp-wexin' ); ?></h2>
			<div class="desktop-qr-content">
				<div class="desktop-qr-content-inner">
					<div class="desktop-qr-code-container">
						<img src="" class="auth-qr-code">
					</div>
					<div class="message">
						<p>
							<?php esc_html_e( 'Scan the QR code with WeChat to authenticate.', 'wp-wexin' ); ?><br/><?php esc_html_e( 'If you do not have an account yet, you will be registered automatically.', 'wp-wexin' ); ?>
						</p>
						<p class="waiting">
						...
						<?php wp_nonce_field( 'qr_code', 'auth_qr_nonce' ); ?>
						<input type="hidden" id="auth_hash" value="">
					</div>
				</div>
			</div>
		</div>
